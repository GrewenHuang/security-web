<template>
    ...
    >
        ...
        <div class="f-b-c">
            <div v-if="!single">
                已选：{{ choosed[0] ? choosed[0].LicensePlateNumber : '未选择车辆' }}
            </div>
            <!--分页 开始-->
            <el-pagination
        ...
        <div slot="footer">
            ...
            <el-tooltip :disabled="!!choosed.length" placement="top" content="请选择车辆">
...
export default {
    ...
    methods: {
        ...
        async getList() {
            ...
            this.loading = true;
            try {
                let res = await this.Post("/GetEnableVehicles", params);
                if (res.status == 2000) {
