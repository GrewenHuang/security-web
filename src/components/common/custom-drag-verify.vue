<template>
	<div class="drag_verify" :style="dragVerifyStyle" @mousemove="dragMoving" @mouseup="dragFinish" @touchmove="dragMoving" @touchend="dragFinish">
			...
			<div class="dv_text" :style="textStyle" ref="message" v-show="false">{{message}}</div>
	...
	methods:{
		...
		dragMoving: function(e){
            if(this.isMoving && !this.isPassing){
                ...
                if(_x > 0 && _x <= (this.width-handlerWidth)){
                    handler.style.left = _x + 'px';
                    this.$refs.progressBar.style.width = (_x+handlerWidth/2)+'px';
                }else if(_x > (this.width-handlerWidth)){  
                	handler.style.left = (this.width - handlerWidth)+ 'px';
                    this.$refs.progressBar.style.width = (this.width-handlerWidth/2)+'px';
                     this.passVerify();
                }
            }
		},
