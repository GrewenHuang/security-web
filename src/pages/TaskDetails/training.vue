<template>
	<page-layout :loading="loading" :pages="pages" @current-change="handleCurrentChange">
		...
		<div slot="operation" class="f-b-c">
			<div class="input-content">
				<el-form :inline="true" :model="filters">
					...
					<el-form-item>
						<el-input placeholder="培训人" clearable v-model="filters.UserName"></el-input>
					</el-form-item>
					<el-form-item>
						<el-input placeholder="培训名称" clearable v-model="filters.TrainTaskName"></el-input>
					</el-form-item>
					<el-form-item>
						<select-position v-model="filters.TrainTaskPositionId" :multiple="false" clearable
							placeholder="培训岗位"></select-position>
					</el-form-item>
					<el-form-item>
						...
						<el-popover width="300" trigger="click">
							<div>
								<el-form-item>
									<el-select placeholder="学习状态" v-model="filters.TrainTaskStatu" style="width: 100%" clearable>
										<el-option v-for="(item, index) in examList" :key="index"
											:label="item.text" :value="item.id"></el-option>
									</el-select>
								</el-form-item>
								<el-form-item>
									<el-select placeholder="考试状态" v-model="filters.ExamStatus" style="width: 100%" clearable>
										<el-option v-for="(item, index) in trainList" :key="index"
											:label="item.text" :value="item.id"></el-option>
									</el-select>
								</el-form-item>
							</div>
		...
		<el-table :data="list" highlight-current-row :header-cell-style="$tableStyle" style="width: 100%"
			...
			<el-table-column label="培训人" align="center" prop="UserName"></el-table-column>
			<el-table-column label="岗前培训名称" align="center" prop="TrainTaskName"></el-table-column>
			<el-table-column label="培训岗位" align="center">
				<template slot-scope="scope">
					{{ scope.row.TrainTaskPosition.map(item => item.PositionName).join('、') }}
				</template>
			</el-table-column>
			<el-table-column label="学习状态" align="center" prop="TrainTaskStatuDesc"></el-table-column>
			<el-table-column label="考试状态" align="center" prop="ExamStateDesc"></el-table-column>
