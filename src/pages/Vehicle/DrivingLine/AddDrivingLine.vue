<template>
	<div class="box">
						...
						<el-col :span='23'>
							<el-form-item label="路线方案" prop="DrivingPolicy">
								<el-select v-model="params.DrivingPolicy" placeholder="请选择"
									@change="DrivingPolicySelect()" style="width: 100%;">
		...
		<el-dialog title="选择途经点" :visible.sync="SelectWayAddressvisible" width="70%" top="5vh">
			<Map @Map='getWayAddressPois($event)' :fatherMethod="ClearMap" />
		</el-dialog>
		<el-dialog title="选择目的地" :visible.sync="SelectEndAddressvisible" width="70%" top="5vh">
			<Map @Map='getEndAddressPois($event)' :fatherMethod="ClearMap" />
		</el-dialog>
		<el-dialog title="选择起运地" :visible.sync="SelectStartAddressvisible" width="70%" top="5vh">
			...
			CanvasDrivingLine() {
				...
				lazyAMapApiLoaderInstance.load().then(() => {
					...
					var map = new AMap.Map("container", {
						...
						// 	"point"
						// ], // 这里指想展示什么数据就设置，目前只支持这四种，下图给出了对应字段的意思
					});
