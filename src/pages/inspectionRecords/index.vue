<template>
    <page-layout :loading="loading" :pages="pages" @current-change="handlePageChange">
        <div slot="operation" class="f-b-c">
            ...
            <div class="f--c">
                <el-button-group>
                    <el-button @click="downloadmbs(1510,15108, filters)" v-if="$_has('AQJCJLBtnExport')">导出</el-button>
                </el-button-group>
            </div>
        </div>
        <el-table
            ...
            >
                <template slot-scope="{ row }">
                    <div class="table-operation">
                        <el-button type="text" @click="preview(row, true)" v-if="$_has('AQJCJLBtnLook')">查看</el-button>
                    </div>
                </template>
            </el-table-column>
        </el-table>
