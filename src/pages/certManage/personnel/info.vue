        ...
        <el-scrollbar ref="scrollbar" class="scrollbar">
            <el-form ref="form" label-position="top" :model="info" :rules="rules">
                <div class="field-list">
                    <el-form-item label="选择人员" prop="ItemId">
                        <el-input placeholder="请选择" v-model="info.ItemName" readonly :disabled="isEdit">
                            <el-button slot="append" @click="choosePersonel" :disabled="isEdit">请选择</el-button>
                        </el-input>
                    </el-form-item>
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ItemId: [{required: true, message: '请选择人员', trigger: ['change','blur']}],
    ...
    methods: {
        ...
        choosePersonel() {
            this.$chooseUser({
                ...
                this.info.ItemId = personnel.UserId;
                this.info.ItemName = personnel.UserName;
            })
        },
    }
}
