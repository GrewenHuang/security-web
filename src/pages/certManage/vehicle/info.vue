        ...
        <el-scrollbar ref="scrollbar" class="scrollbar">
            <el-form ref="form" label-position="top" :model="info" :rules="rules">
                <div class="field-list">
                    <el-form-item label="选择车辆" prop="ItemId">
                        <el-input placeholder="请选择" v-model="info.ItemName" readonly :disabled="isEdit">
                            <el-button slot="append" @click="chooseVehicles" :disabled="isEdit">请选择</el-button>
                        </el-input>
                    </el-form-item>
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ItemId: [{required: true, message: '请选择车辆', trigger: ['change','blur']}],
    ...
    methods: {
        ...
        chooseVehicles() {
            this.$chooseVehicles({
                ...
                this.info.ItemId = personnel.VehicleId;
                this.info.ItemName = personnel.LicensePlateNumber;
            })
        },
    }
}
