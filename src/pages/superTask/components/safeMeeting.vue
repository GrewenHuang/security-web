<template>
    <el-dialog v-dialog-drag 
        ...
        @close="close()"
        class="super-safe-meeting-info"
        width="1000px"
        top="8vh"
    >
        <el-scrollbar class="scrollbar" ref="scrollbar">
            <el-form ref="form" :rules="rules" label-position="top" :model="info">
                ...
                <el-form-item
                    ...
                    <div class="second-content f--c">
                        <div>
                            <el-dropdown trigger="click" @command="changeSeconds($event, 'h')" placement="bottom-start">
                        ...
                        <div>
                            <el-dropdown trigger="click" @command="changeSeconds($event, 'm')" placement="bottom-start">
                                <div class="second-item">
                                    <span>
                                        <span>{{ hms.m }}</span>
                                    </span>
                        ...
                        <div>
                            <el-dropdown trigger="click" @command="changeSeconds($event, 's')" placement="bottom-start">
                                <div class="second-item">
                                    <span>
                                        <span>{{ hms.s }}</span>
                                    </span>
                        ...
                        <el-input v-model="info.MaxTime" style="width:0;height:0;opacity:0;overflow:hidden;"></el-input>
                    </div>
                </el-form-item>
                <div class="f-b-c">
    ...
    methods: {
        async show(item) {
            ...
            if (item) {
                ...
                try {
                    let res = await this.Get(`/GetEnterpriseTaskSafetyMeeting?id=${item.RelationId}`);
                    if (res.status == 2000) {
            ...
            this.$refs.form.validate(async valid => {
                if (valid) {
                    ...
                    try {
                        ...
                        let res = await this.Post('/SaveEnterpriseSafetyMeeting', params);
                        if (res.status === 2000) {
