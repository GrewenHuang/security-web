    ...
    <page-layout :loading="loading" :pages="pages" @current-change="handlePageChange">
        <div slot="operation" class="f-b-c">
            <div class="input-content">
                <el-input clearable placeholder="保险名称" v-model="filters.CertificateName"></el-input>
            ...
            <div class="f--c">
                <el-button type="primary" @click="add()" v-if="$_has('ZZMBSZBXTab')">新增</el-button>
            </div>
        </div>
        <div class="cert-list">
            <div class="cert-item"
                ...
                :key="index"
                :class="`cert-item-${item.CertificateType}`"
                @click="add(item)"
            >   
                <div class="cert-name">
                    <el-tooltip>
                ...
                <div class="left">
                    <el-scrollbar ref="scrollbar1" class="el-scrollbar">
                        <div class="cover-image " :class="`cert-image-${formData.CertificateType}`">
                            <div class="title">{{ formData.CertificateName || '请在右侧输入保险名称'}}</div>
                        </div>
                        <div class="form">
                    ...
                    <el-scrollbar ref="scrollbar" class="el-scrollbar">
                        <el-form ref="formData" :model="formData" :rules="rules">
                            <div class="f-b-c">
                                ...
                                <el-form-item class="f1" label="保险名称" ref="CertificateName" prop="CertificateName">
                            ...
                            >
                                ...
                                >
                                    <template slot-scope="{ row }">
                                        <el-input placeholder="请输入" v-model="row.FiledName" :disabled="row.IsDefault == 1"></el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column
                                    label="文本类型"
...
const formVue = {
    ...
    methods: {
        ...
        removeCert() {
            this.$confirm('确认删除该保险吗？', '提示', {}).then((_) => {
...
.cert-list{
    ...
    .cert-item{
        ...
        @for $i from 1 through 4 {
            &-#{$i}{
                background: url(../../../assets/images/cert/insure#{$i}.png) no-repeat center center;
