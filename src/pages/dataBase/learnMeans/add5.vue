    ...
    >
        <el-scrollbar ref="scrollbar" class="scrollbar">
            <el-form ref="form" label-position="top" :model="info" :rules="rules">
                ...
                <el-form-item label="专题类型" prop="CategoryCode">
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                CategoryCode: [{required: true, message: '请选择专题类型', trigger: ['change', 'blur']}],
            },
            typeList: [],
        }
    },
    ...
    methods: {
        async show(item) {
            ...
            this.typeList = await this.getDictionaryById('200006');
            if (item) {
                this.loading = true;
