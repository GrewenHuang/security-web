<template>
    <el-dialog v-dialog-drag 
        class="occupational-critical-illness-filing-add"
        :title="title"
        :visible.sync="isShow"
        @close="close"
        width="210mm"
    ...
    >
        <el-scrollbar class='scrollbar'>
            ...
            >
                ...
                <div class="form-col">
                    <el-form-item label="备案部门" prop="DeclarationFilingName">
                        <el-input v-model.trim="info.DeclarationFilingName" placeholder="请输入" :disabled="isPreview"></el-input>
                    </el-form-item>
                    <el-form-item label="上报时间" prop="DeclarationFilingDate">
                        <div class="el-input">
                ...
                <el-form-item label="接收人" prop="IsPass">
                    <el-input placeholder="请选择" v-model="info.RecipientName" readonly :disabled="isPreview">
    ...
    methods: {
        ...
        getParams() {
            let params = Object.assign({
                OccupationalHazardRecordType: 2
            }, this.info);
            return params;
        },
        async submit() {
        ...
        choosePersonel() {
            this.$chooseUser({
                ...
                this.info.RecipientId = personnel.UserId;
                this.info.RecipientName = personnel.UserName;
            })
        },
    },
};
...
.occupational-critical-illness-filing-add {
    color: #000;
    .container {
