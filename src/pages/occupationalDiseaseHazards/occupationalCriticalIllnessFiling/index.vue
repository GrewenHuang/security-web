<template>
    <page-layout class="occupational-critical-illness-filing warp"
        :loading="loading"
        :pages="pages"
    ...
    >
            ...
            <div slot="operation" class="f-b-c">
                ...
                <div class="f-c-c">
                    <el-button-group style="margin-right: 20px;">
                        <el-button @click="downloadmbs(910,9102,filters)">导出</el-button>
                    </el-button-group>
                    <el-button
                        type="primary"
                        icon="el-icon-plus"
            ...
            <!-- 列表 结束 -->
        <add ref="occupationalCriticalIllnessFilingAdd" @success="getFirstPage"/>
    </page-layout>
</template>
  <script>
...
export default {
    ...
    methods: {
        addRecord(item, isPreview) {
            this.$refs.occupationalCriticalIllnessFilingAdd.show(item, isPreview);
        },
        //分页事件
...
<style lang="scss" scoped>
    .occupational-critical-illness-filing{
        /deep/ .el-input--small{
            width: 180px;
        }
    }
