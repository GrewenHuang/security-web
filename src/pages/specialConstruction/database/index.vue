<template>
    ...
    >
        ...
        >
            ...
            <el-table-column prop="Name" label="专项施工方案名称"> </el-table-column>
            <el-table-column
    ...
    methods: {
        ...
        remove(index, row) {
            ...
            than.$confirm("确认删除该记录吗?", "提示", { type: "warning" }).then(async () => {
                than.loading = true;
                let res = await this.Post(`/DeleteSpecialItemDatabase`, {
                    Ids: [row.SpecialItemDatabaseId]
                });
                if (res.status == 2000) {
