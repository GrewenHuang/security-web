        ...
        <div slot="operation" class="f-b-c">
            <div class="input-content">
                ...
                <el-input
                    placeholder="编制人"
                    clearable
                    v-model="filters.SpecialItemUserName"
                ></el-input>
                <el-date-picker
                    type="date"
                    ...
                    placeholder="编制时间"
                    clearable
                    v-model="filters.SpecialItemDate"
                ></el-date-picker>
                <el-input
                    placeholder="下发人"
                    clearable
    ...
    methods: {
        ...
        remove(row) {
            this.$confirm('确认删除该条数据吗？').then((_) => {
                this.Post('/DeleteSpecialItem', {
                    Ids: [row.SpecialItemId],
                }).then((res) => {
                    if (res.status == 2000) {
                        this.getList();
                        this.$message({
