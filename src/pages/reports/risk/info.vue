<template>
	<page-layout class="warp" :loading="loading" :pages="pages" @current-change="handleCurrentChange">
		...
		<el-table class='tableStyle' :data="list" style="width:100%;" :header-cell-style="$tableStyle"
			...
			<el-table-column label="所属部门" align="center" width="100" prop="DepartmentName"
			...
			<el-table-column prop="InspectorName" align="center" width="120" label="巡查人"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			GetList() {
				...
				this.Post('/GetRiskInspections', params)
					.then(
						function(result) {
