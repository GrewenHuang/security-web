        ...
        <el-scrollbar ref="scrollbar" class="scrollbar">
            <el-collapse v-model="activeNames">
                ...
                <el-collapse-item :name="2">
                    ...
                    <div class="form-col form-item">
                        <div class="f--c">
                            <div class="label">维修完成日期：</div>
                            <div>{{ info.RepairDateDesc }}</div>
                        </div>
                    </div>
                    <div class="f--c form-item">
                        <div class="label">维修照片：</div>
                        <div>
                            <el-image
                                style="width: 90px;height: 90px;"
                                v-for="(item, index) in info.RepairRecordPhotos"
                                :key="index"
                                :src="item.url"
                                :preview-src-list="info.RepairRecordPhotos.map(item=>item.url)"
                            ></el-image>
                        </div>
                    </div>
                </el-collapse-item>
