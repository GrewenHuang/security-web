        ...
        <div slot="operation" class="f-b-c">
            <div class="input-content">
                ...
                <el-popover
                    ...
                    trigger="hover">
                        <div>
                            <el-select placeholder="设备类型" clearable v-model="filters.type">
            ...
            <div class="f--c">
                <el-button @click="downloadmbs(1310, 13105, filters)">导出</el-button>
            </div>
        </div>
        <el-table
            :data="list"
...
export default {
    ...
    methods: {
        ...
        async getList() {
            ...
            this.loading = true;
            try {
                let res = await this.Post('/GetRepairRecordList', params);
                if (res.status === 2000) {
