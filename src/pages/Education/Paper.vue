    ...
    <page-layout class="warp" :loading="loading" :pages="pages" @current-change="handleCurrentChange">
        ...
        <div slot="operation" class="f-b-c">
            <div class="input-content">
                <el-input
                    v-model="filters.ExaminationPaperNumber"
                    placeholder="试卷编号"
                    @keyup.enter.native="handleSearch"
                ></el-input>
                <el-input
                    v-model="filters.ExaminationPaperName"
                    placeholder="试卷名称"
                    @keyup.enter.native="handleSearch"
                ></el-input>
            ...
            >
                <template slot-scope="scope">
                    <div class="table-operation">
                        <el-button
                            type="text"
                            @click="see(scope.row.ExaminationPaperId)"
                            >查看</el-button
                        >
                        <el-button
                            type="text"
                        ...
                        <el-button
                            type="text"
                            text-plain
                            @click="delP(scope.row.ExaminationPaperId)"
                            >删除</el-button
                        >
                    </div>
                </template>
        ...
        >
            <el-scrollbar class="scrollbar">
                    ...
                    <div>
                        ...
                        >
                            <div class="form-col">
                                ...
                                >
                                    <el-input
                                        v-model="parms.ExaminationPaperName"
                                        placeholder="请输入试卷名称"
                                        maxlength="50"
                                        show-word-limit
                                    ></el-input>
                            ...
                            >
                                <div class="el-input">
                                    <el-switch
                                        ...
                                        inactive-text="关闭"
                                        v-model="IsTime"
                                        @change="seletSetTestTime($event)"
                                    >
                                    </el-switch>
                                    <el-input-number
                                        :min="0"
                                        :max="1000"
                                        v-model="parms.TestTime"
                                        :disabled="!IsTime"
                                    ></el-input-number>
                                </div>
                            </el-form-item>
                ...
                <el-card style='margin-top:10px;'
                    v-for='(item,index) in parms.ExaminationPaperRules'
                    :key='index'
                    class="collapse-box"
                    >
                    <el-collapse  v-model="activeNames" >
                        ...
                        >
                            ...
                            <el-switch style="float: right; padding: 3px 0"
                                    v-model='item.Status'
                                    @change="IsStatus($event,index,item)"
                                    :active-value="1"
                                    :inactive-value="0"
                                    active-text="开启"
                                    inactive-text="关闭">
        ...
        >
            <el-scrollbar class="scrollbar">
                ...
                <el-table
                    ...
                    border
                    style="width: 100%"
                    @selection-change="chooseQuestions"
                >
            ...
            <div slot="footer" class="dialog-footer">
                <el-button @click="submitSelectQuestions" type="primary"
                    >确定</el-button
                >
            </div>
        </el-dialog>
        ...
        submit(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    this.Post("/SaveExaminationPaper", {...this.parms, IsPrivate}).then(
                        (res) => {
                            if (res.status == 2000) {
                                this.$message({
                                    message: "保存成功",
