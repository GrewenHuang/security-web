    ...
    >
        ...
        <div slot="operation" class="f-b-c">
            <div class="input-content">
                <el-input
                    v-model="filters.CurriculumNo"
                    placeholder="课程编号"
                    @keyup.enter.native="handleSearch"
                ></el-input>
                <el-input
                    v-model="filters.CurriculumName"
                    placeholder="课程名称"
                    @keyup.enter.native="handleSearch"
                ></el-input>
            ...
            >
                <template slot-scope="scope">
                    <div class="table-operta">
                        <el-button type="text" @click="seeCour(scope.row)"
                            >查看</el-button
                        >
                        <el-button
                            type="text"
                            @click="editCour(scope.row)"
                            >编辑</el-button
                        >
                        <el-button
                            type="text"
                            text-plain
                            @click="delCour(scope.row.CurriculumId)"
                            >删除</el-button
                        >
                    </div>
                </template>
        ...
        >
            ...
            <el-input v-model="filterss.SerialNumber"
                ...
                <el-form-item>
                    <el-input
                        v-model="filterss.CoursewareName"
                        placeholder="课件名称"
    ...
    methods: {
        ...
        submit(formName) {
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    this.Post("/SaveCurriculum", {...this.parms, IsPrivate}).then((res) => {
                        if (res.status == 2000) {
                            this.$message({
                                message: "保存成功",
                                type: "success",
