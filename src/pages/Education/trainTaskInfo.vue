<template>
    <el-dialog v-dialog-drag :title="title" :visible.sync="dislogShow" @close="close()" class="info" width="1200px"
        ...
        <el-form :inline="true" :model="filters" @submit.native.prevent>
            ...
            <el-button class="btn" type="warning" style="float: right; margin-bottom: 10px" icon="el-icon-download"
        ...
        <div class="content">
            <el-table :data="list" :cell-style="{ textAlign: 'center' }" :header-cell-style="$tableStyle" style="width: 100%"
                ...
                <el-table-column type="expand" v-if="isType == 0">
...
export default {
    ...
    methods: {
       show(row) {
			...
			this.filters.TrainTaskId = row.TrainTaskId;
			this.isType = row.TrainWay
            this.getInfoList();
        },
        close() {
