<template>
    ...
    >
        ...
        <!-- 
         ...
         -->
        <tr>
            <td colspan="2">吊装地点</td>
            <td>{{ specialFields.field1 }}</td>
            <td>吊具名称</td>
            <td>{{ specialFields.field2 }}</td>
            <td colspan="2">吊物内容</td>
            <td colspan="2">{{ specialFields.field3 }}</td>
        </tr>
        <tr>
            <td colspan="2">吊装作业人</td>
            <td>{{ getValueByName('吊装作业人') }}</td>
            <td>司索人</td>
            <td>{{ getValueByName('司索人') }}</td>
            <td colspan="2">监护人</td>
            <td colspan="2">{{ getValueByName('监护人') }}</td>
        </tr>
        <tr>
            <td colspan="2">指挥人员</td>
            <td>{{ getValueByName('指挥人') }}</td>
            <td colspan="2">吊物质量（T）及作业级别</td>
            <td colspan="4">{{ specialFields.field4 }}</td>
        </tr>
        <!-- <tr>
        ...
        <tr>
            ...
            <td colspan="7">{{ riskResult }}</td>
        </tr>
        <tr>
            <td colspan="2">作业实施时间</td>
            <td colspan="7">自 {{ baseInfo.JobTicketStartTimeDesc | format(dateFormatStr) }} 至 {{ baseInfo.JobTicketEndTimeDesc | format(dateFormatStr) }} 止</td>
        </tr>
        <tr>
            <td>序号</td>
